...
$
    () / (Γ, x : τ ⊢ x : τ) \
    () / (Γ ⊢ λ: "typeof"(λ)) \
    (Γ ⊢ e_1: τ_1 space.quad ... space.quad Γ ⊢ e_n: τ_n) / (Γ ⊢ [e_1, ..., e_n]: [τ_1, ..., τ_n]) \
    (Γ ⊢ e_1: τ_1 space.quad ... space.quad Γ ⊢ e_n: τ_n) / (Γ ⊢ {k_1: e_1 space ; space ... space ; space k_n: e_n}: {k_1: τ_1 space ; space ... space ; space k_n: τ_n}) \
    (Γ, x_1: τ_1, ..., x_n: τ_n ⊢ e: ρ) / (Γ ⊢ (x_1: τ_1, ..., x_n: τ_n) → e: (τ_1, ..., τ_n) → ρ) \
    (Γ ⊢ e_1: [τ_1, ..., τ_n] space.quad Γ ⊢ e_2: i) / (Γ ⊢ e_1[e_2]: τ_i) \
    (Γ ⊢ e_1: [τ_1, ..., τ_n] space.quad Γ ⊢ e_2: σ space.quad σ ⪯ int) / (Γ ⊢ e_1[e_2]: τ_1 ∣ ... ∣ τ_n) \
    (Γ ⊢ e_1: any) / (Γ ⊢ e_1[e_2]: any) \
